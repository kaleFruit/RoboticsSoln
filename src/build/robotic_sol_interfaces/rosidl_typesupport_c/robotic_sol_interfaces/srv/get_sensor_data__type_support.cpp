...
static const _GetSensorData_Request_type_support_symbol_names_t _GetSensorData_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotic_sol_interfaces, srv, GetSensorData_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotic_sol_interfaces, srv, GetSensorData_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotic_sol_interfaces, srv, GetSensorData_Request)() {
  return &::robotic_sol_interfaces::srv::rosidl_typesupport_c::GetSensorData_Request_message_type_support_handle;
}
...
static const _GetSensorData_Response_type_support_symbol_names_t _GetSensorData_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotic_sol_interfaces, srv, GetSensorData_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotic_sol_interfaces, srv, GetSensorData_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotic_sol_interfaces, srv, GetSensorData_Response)() {
  return &::robotic_sol_interfaces::srv::rosidl_typesupport_c::GetSensorData_Response_message_type_support_handle;
}
...
static const _GetSensorData_type_support_symbol_names_t _GetSensorData_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotic_sol_interfaces, srv, GetSensorData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotic_sol_interfaces, srv, GetSensorData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, robotic_sol_interfaces, srv, GetSensorData)() {
  return &::robotic_sol_interfaces::srv::rosidl_typesupport_c::GetSensorData_service_type_support_handle;
}
